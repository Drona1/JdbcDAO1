...
public abstract class AbstractDAO<T> {
    ...
    public void add(T t) {
        try {
            ...
            sendToDBAndSetID(t, sql, id.getName());
    ...
    private void sendToDBAndSetID(T t, String sql, String idFieldName) throws SQLException {
        ...
        try {
            try (Statement st = conn.createStatement()) {
                ...
                try (ResultSet rs = st.executeQuery(sql)) {
                    Field field = t.getClass().getDeclaredField(idFieldName);
